...
var G__9984_9986 = reagent.impl.template.prop_name_cache;
var G__9985_9987 = cljs.core.name(k);
goog.object.set(G__9984_9986,G__9985_9987);
...
var G__9988 = o;
var G__9989_9992 = G__9988;
var G__9990_9993 = reagent.impl.template.cached_prop_name(k);
var G__9991_9994 = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v));
goog.object.set(G__9989_9992,G__9990_9993,G__9991_9994);
...
while (G__9996__i < G__9996__a.length) {G__9996__a[G__9996__i] = arguments[G__9996__i + 0]; ++G__9996__i;}
  args = new cljs.core.IndexedSeq(G__9996__a,0,null);
} 
...
if((temp__5737__auto__ == null)){
var v = reagent.impl.util.dash_to_prop_name(k);
var G__9998_10001 = reagent.impl.template.custom_prop_name_cache;
var G__9999_10002 = cljs.core.name(k);
var G__10000_10003 = v;
goog.object.set(G__9998_10001,G__9999_10002,G__10000_10003);
...
var G__10004 = o;
var G__10005_10008 = G__10004;
var G__10006_10009 = reagent.impl.template.cached_custom_prop_name(k);
var G__10007_10010 = reagent.impl.template.convert_prop_value(v);
goog.object.set(G__10005_10008,G__10006_10009,G__10007_10010);
...
while (G__10012__i < G__10012__a.length) {G__10012__a[G__10012__i] = arguments[G__10012__i + 0]; ++G__10012__i;}
  args = new cljs.core.IndexedSeq(G__10012__a,0,null);
} 
...
var G__10014 = props;
var G__10014__$1 = (((((!((id == null)))) && ((cljs.core.cst$kw$id.cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10014,cljs.core.cst$kw$id,id):G__10014);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10014__$1,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,cljs.core.cst$kw$class.cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__10014__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__10015 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__10015,cljs.core.cst$kw$class,reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__10015;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__10016){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__10017__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__10017,map__10017__$1,on_write){
return (function (){
...
});})(node_value,map__10017,map__10017__$1,on_write))
);
} else {
...
return reagent.impl.template.input_handle_change(this$,on_change,p1__10019_SHARP_);
});})(v,value,on_change))
;
} else {
return null;
...
var vec__10022 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10022,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10022,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10022,(2),null);
...
var temp__5739__auto___10026 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___10026 == null)){
} else {
var key_10027 = temp__5739__auto___10026;
jsprops.key = key_10027;
}
...
var temp__5739__auto___10028 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___10028 == null)){
} else {
var key_10029 = temp__5739__auto___10028;
jsprops.key = key_10029;
}
...
var G__10030 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__10030) : reagent.impl.template.as_element.call(null,G__10030));
} else {
var temp__5739__auto___10031 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___10031 == null)){
} else {
var key_10032 = temp__5739__auto___10031;
jsprops.key = key_10032;
}
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq10036){
var G__10037 = cljs.core.first(seq10036);
var seq10036__$1 = cljs.core.next(seq10036);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10037,seq10036__$1);
});
...
break;
default:
var G__10043 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__10043;
continue;
...
var ctx = ({});
var vec__10045 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10045,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__10045,(1),null);
...
var G__10048 = (cljs.core.count(argv) - first_child);
switch (G__10048) {
case (0):
...
break;
case (1):
var G__10049 = component;
var G__10050 = jsprops;
var G__10051 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__10049,G__10050,G__10051) : reagent.impl.template.global$module$react.createElement.call(null,G__10049,G__10050,G__10051));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__10048){
