...
return (new CustomEvent(event_name,(function (){var obj39704 = ({"detail":data});
return obj39704;
})()));
} else {
...
var f = (function (){var pred__39711 = cljs.core._EQ_;
var expr__39712 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__39711.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__39712))){
return ((function (pred__39711,expr__39712){
return (function (p1__39705_SHARP_){
return console.warn(p1__39705_SHARP_);
});
;})(pred__39711,expr__39712))
} else {
if(cljs.core.truth_(pred__39711.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__39712))){
return ((function (pred__39711,expr__39712){
return (function (p1__39706_SHARP_){
return console.debug(p1__39706_SHARP_);
});
;})(pred__39711,expr__39712))
} else {
if(cljs.core.truth_(pred__39711.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__39712))){
return ((function (pred__39711,expr__39712){
return (function (p1__39707_SHARP_){
return console.error(p1__39707_SHARP_);
});
;})(pred__39711,expr__39712))
} else {
return ((function (pred__39711,expr__39712){
return (function (p1__39708_SHARP_){
return console.log(p1__39708_SHARP_);
});
;})(pred__39711,expr__39712))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__39715){
...
return new_def.callback(p1__39718_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__39720,(0),null);
var v = cljs.core.nth.call(null,vec__39720,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1620067000130
