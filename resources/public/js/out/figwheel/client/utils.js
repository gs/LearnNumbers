...
return (new CustomEvent(event_name,(function (){var obj29639 = ({"detail":data});
return obj29639;
})()));
} else {
...
var f = (function (){var pred__29646 = cljs.core._EQ_;
var expr__29647 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__29646.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__29647))){
return ((function (pred__29646,expr__29647){
return (function (p1__29640_SHARP_){
return console.warn(p1__29640_SHARP_);
});
;})(pred__29646,expr__29647))
} else {
if(cljs.core.truth_(pred__29646.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__29647))){
return ((function (pred__29646,expr__29647){
return (function (p1__29641_SHARP_){
return console.debug(p1__29641_SHARP_);
});
;})(pred__29646,expr__29647))
} else {
if(cljs.core.truth_(pred__29646.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__29647))){
return ((function (pred__29646,expr__29647){
return (function (p1__29642_SHARP_){
return console.error(p1__29642_SHARP_);
});
;})(pred__29646,expr__29647))
} else {
return ((function (pred__29646,expr__29647){
return (function (p1__29643_SHARP_){
return console.log(p1__29643_SHARP_);
});
;})(pred__29646,expr__29647))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__29650){
...
var eval_fn = cljs.core.get.call(null,map__29651__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__29653_SHARP_);
});})(new_def))
);
...
return (function (p__29654){
var vec__29655 = p__29654;
var ky = cljs.core.nth.call(null,vec__29655,(0),null);
...
}catch (e29660){if((e29660 instanceof Error)){
var e = e29660;
return not_found;
} else {
throw e29660;
...
//# sourceMappingURL=utils.js.map?rel=1620918627392
