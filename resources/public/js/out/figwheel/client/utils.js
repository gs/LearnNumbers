...
return (new CustomEvent(event_name,(function (){var obj29173 = ({"detail":data});
return obj29173;
})()));
} else {
...
var f = (function (){var pred__29225 = cljs.core._EQ_;
var expr__29226 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__29225.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__29226))){
return ((function (pred__29225,expr__29226){
return (function (p1__29200_SHARP_){
return console.warn(p1__29200_SHARP_);
});
;})(pred__29225,expr__29226))
} else {
if(cljs.core.truth_(pred__29225.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__29226))){
return ((function (pred__29225,expr__29226){
return (function (p1__29203_SHARP_){
return console.debug(p1__29203_SHARP_);
});
;})(pred__29225,expr__29226))
} else {
if(cljs.core.truth_(pred__29225.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__29226))){
return ((function (pred__29225,expr__29226){
return (function (p1__29204_SHARP_){
return console.error(p1__29204_SHARP_);
});
;})(pred__29225,expr__29226))
} else {
return ((function (pred__29225,expr__29226){
return (function (p1__29205_SHARP_){
return console.log(p1__29205_SHARP_);
});
;})(pred__29225,expr__29226))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__29241){
var map__29247 = p__29241;
...
var opts = map__29247__$1;
var eval_fn = cljs.core.get.call(null,map__29247__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__29257_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__29292,(0),null);
var v = cljs.core.nth.call(null,vec__29292,(1),null);
...
}catch (e29312){if((e29312 instanceof Error)){
var e = e29312;
return not_found;
} else {
throw e29312;
...
//# sourceMappingURL=utils.js.map?rel=1620507840898
