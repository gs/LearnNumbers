...
var o33834 = temp__5733__auto__;
var temp__5733__auto____$1 = (o33834["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o33835 = temp__5733__auto____$1;
return (o33835["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__32841__auto__ = f;
return (o__32841__auto__["toString"]).call(o__32841__auto__);
} else {
return "";
}
}catch (e33836){var _ = e33836;
return "";
}});
...
try{var o__32841__auto___33838 = t;
(o__32841__auto___33838["cljs$lang$ctorPrWriter"]).call(o__32841__auto___33838,t,writer);
}catch (e33837){var __33839 = e33837;
}
...
var char_code = (function (){var o__32841__auto__ = (new String(char$));
return (o__32841__auto__["charCodeAt"]).call(o__32841__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__32841__auto__ = String;
return (o__32841__auto__["fromCharCode"]).call(o__32841__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__33840 = num_code;
switch (G__33840) {
case (1):
return (185);
...
var o__32841__auto__ = String;
return (o__32841__auto__["fromCharCode"]).call(o__32841__auto__,superscript_code);
});
/**
...
}catch (e33842){var _e__32848__auto__ = e33842;
return false;
}})())){
...
var vec__33843 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__33843,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o33846 = temp__5733__auto__;
var temp__5733__auto____$1 = (o33846["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o33847 = temp__5733__auto____$1;
return (o33847["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__33850){
var vec__33851 = p__33850;
var ns_detector = cljs.core.nth.call(null,vec__33851,(0),null);
...
var G__33857 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__33858 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__33857;
remaining_tokens = G__33858;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq33848){
var G__33849 = cljs.core.first.call(null,seq33848);
var seq33848__$1 = cljs.core.next.call(null,seq33848);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33849,seq33848__$1);
});
...
var vec__33862 = cljs.core.split_with.call(null,(function (p1__33861_SHARP_){
return cljs.core.not_EQ_.call(null,p1__33861_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__33862,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__33862,(1),null);
...
var vec__33868 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__33868,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__33868,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__33871 = cljs.core.rest.call(null,remaining_tokens);
var G__33872 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__33871;
name_tokens = G__33872;
continue;
} else {
...
var vec__33875 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__33875,(0),null);
var arity = cljs.core.nth.call(null,vec__33875,(1),null);
var vec__33878 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__33878,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__33878,(1),null);
var vec__33881 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__33881,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__33881,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__33881,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__33881,(3),null);
...
var vec__33887 = result;
var munged_ns = cljs.core.nth.call(null,vec__33887,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__33887,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__33887,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__33887,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__33887,(4),null);
var arity = cljs.core.nth.call(null,vec__33887,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__33891 = temp__5733__auto__;
var munged_name = cljs.core.nth.call(null,vec__33891,(0),null);
var args = cljs.core.nth.call(null,vec__33891,(1),null);
var vec__33894 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__33894,(0),null);
var name = cljs.core.nth.call(null,vec__33894,(1),null);
...
var G__33897 = (arity + (1));
var G__33898 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__33899){
var vec__33900 = p__33899;
var arity = cljs.core.nth.call(null,vec__33900,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__33900,(1),null);
...
return cljs.core.get.call(null,arities,p1__33903_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__33904_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__33907){
var vec__33908 = p__33907;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__33908,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq33905){
var G__33906 = cljs.core.first.call(null,seq33905);
var seq33905__$1 = cljs.core.next.call(null,seq33905);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33906,seq33905__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__33916__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__33916__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__33916__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__33916__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__33917 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__33917,(0),null);
var fn_name = cljs.core.nth.call(null,vec__33917,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__33917,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__33917,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__33917,(4),null);
var arity = cljs.core.nth.call(null,vec__33917,(5),null);
...
var o__32841__auto__ = f;
return (o__32841__auto__["getBasis"]).call(o__32841__auto__);
});
/**
...
}catch (e33921){var _e__32848__auto__ = e33921;
...
var G__33922 = (obj[cljs.core.first.call(null,path)]);
var G__33923 = cljs.core.rest.call(null,path);
obj = G__33922;
path = G__33923;
continue;
} else {
...
return (function (accum,p__33924){
var vec__33925 = p__33924;
var bit = cljs.core.nth.call(null,vec__33925,(0),null);
var protocol = cljs.core.nth.call(null,vec__33925,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__33928){
var vec__33929 = p__33928;
var ns = cljs.core.nth.call(null,vec__33929,(0),null);
var name = cljs.core.nth.call(null,vec__33929,(1),null);
var selector = cljs.core.nth.call(null,vec__33929,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__33934,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__33934,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__33934,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__33932_SHARP_){
return (obj[cljs.core.first.call(null,p1__33932_SHARP_)]);
});})(name,sorted_matches,vec__33934,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1620066997731
